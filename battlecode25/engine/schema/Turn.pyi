...
class Turn(object):
  ...
  def X(self) -> int: ...
  def Y(self) -> int: ...
  def ActionsType(self, i: int) -> typing.Literal[Action.NONE, Action.DamageAction, Action.PaintAction, Action.UnpaintAction, Action.MarkAction, Action.UnmarkAction, Action.AttackAction, Action.MopAction, Action.BuildAction, Action.TransferAction, Action.MessageAction, Action.SpawnAction, Action.DieAction, Action.UpgradeAction, Action.IndicatorStringAction, Action.IndicatorDotAction, Action.IndicatorLineAction]: ...
  def ActionsTypeAsNumpy(self) -> np.ndarray: ...
  def ActionsTypeLength(self) -> int: ...
  def ActionsTypeIsNone(self) -> bool: ...
  def Actions(self, i: int) -> typing.Literal[Action.NONE, Action.DamageAction, Action.PaintAction, Action.UnpaintAction, Action.MarkAction, Action.UnmarkAction, Action.AttackAction, Action.MopAction, Action.BuildAction, Action.TransferAction, Action.MessageAction, Action.SpawnAction, Action.DieAction, Action.UpgradeAction, Action.IndicatorStringAction, Action.IndicatorDotAction, Action.IndicatorLineAction]: ...

...
class Round(object):
  ...
  def TeamResourcePatternAmounts(self, i: int) -> typing.List[int]: ...
  def TeamResourcePatternAmountsAsNumpy(self) -> np.ndarray: ...
...
def RoundAddTeamResourcePatternAmounts(builder: flatbuffers.Builder, teamResourcePatternAmounts: uoffset) -> None: ...
def RoundStartTeamResourcePatternAmountsVector(builder: flatbuffers.Builder, num_elems: int) -> uoffset: ...
def StartTeamResourcePatternAmountsVector(builder: flatbuffers.Builder, num_elems: int) -> uoffset: ...

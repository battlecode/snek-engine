...
class Game:
    ...
    def spawn_robot(self, type: RobotType, loc: MapLocation, team: Team, id=None):
        ...
        methods = {
            ...
            'get_round_num': rc.get_round_num,
            'get_map_width': rc.get_map_width,
            'get_map_height': rc.get_map_height,
            'get_resource_pattern': rc.get_resource_pattern,
            'get_tower_pattern': rc.get_tower_pattern,
            'get_id': rc.get_id,
            'get_team': rc.get_team,
            'get_location': rc.get_location,
            'get_health': rc.get_health,
            'get_paint': rc.get_paint,
            'get_money': rc.get_money,
            'get_type': rc.get_type,
            'on_the_map': rc.on_the_map,
            'can_sense_location': rc.can_sense_location,
            'is_location_occupied': rc.is_location_occupied,
            'can_sense_robot_at_location': rc.can_sense_robot_at_location,
            'sense_robot_at_location': rc.sense_robot_at_location,
            'can_sense_robot': rc.can_sense_robot,
            'sense_robot': rc.sense_robot,
            'sense_nearby_robots': rc.sense_nearby_robots,
            'sense_passability': rc.sense_passability,
            'sense_map_info': rc.sense_map_info,
            'sense_nearby_map_infos': rc.sense_nearby_map_infos,
            'adjacent_location': rc.adjacent_location,
            'get_all_locations_within_radius_squared': rc.get_all_locations_within_radius_squared,
            'is_action_ready': rc.is_action_ready,
            'get_action_cooldown_turns': rc.get_action_cooldown_turns,
            'is_movement_ready': rc.is_movement_ready,
            'get_movement_cooldown_turns': rc.get_movement_cooldown_turns,
            'can_move': rc.can_move,
            'move': rc.move,
            'can_build_robot': rc.can_build_robot,
            'build_robot': rc.build_robot,
            'can_mark': rc.can_mark,
            'mark': rc.mark,
            'can_remove_mark': rc.can_remove_mark,
            'remove_mark': rc.remove_mark,
            ...
            'can_complete_tower_pattern': rc.can_complete_tower_pattern,
            'complete_tower_pattern': rc.complete_tower_pattern,
            'can_complete_resource_pattern': rc.can_complete_resource_pattern,
            'complete_resource_pattern': rc.complete_resource_pattern,
            'can_attack': rc.can_attack,
            'attack': rc.attack,
            'can_mop_swing': rc.can_mop_swing,
            'mop_swing': rc.mop_swing,
            'can_send_message': rc.can_send_message,
            'send_message': rc.send_message,
            'read_messages': rc.read_messages,
            'can_transfer_paint': rc.can_transfer_paint,
            'transfer_paint': rc.transfer_paint,
            'can_upgrade_tower': rc.can_upgrade_tower,

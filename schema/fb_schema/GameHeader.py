...
class GameHeader(object):
    ...
    def Teams(self, j):
        ...
        if o != 0:
            ...
            from fb_schema.TeamData import TeamData
            obj = TeamData()
    ...
    def RobotTypeMetadata(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from fb_schema.RobotTypeMetadata import RobotTypeMetadata
    ...
    def Constants(self):
        ...
        if o != 0:
            ...
            from fb_schema.GameplayConstants import GameplayConstants
